...
var (
	...
	sumOfGridAndPVWatts = promauto.NewGauge(prometheus.GaugeOpts{
		Name: "sum_of_grid_and_pv_watts",
		Help: "Sum of Grid and PV watts. (sometimes slightly inaccurate?)",
	})
	timeSyncRequestsTotal = promauto.NewCounter(prometheus.CounterOpts{
		Name: "time_sync_requests_total",
		Help: "Count of outbound time sync requests.",
	})
	timeSyncAckRequestsTotal = promauto.NewCounter(prometheus.CounterOpts{
	...
	unknownRequestsTotal = promauto.NewCounter(prometheus.CounterOpts{
		Name: "unknown_requests_total",
		Help: "Count of outbound unknown requests.",
	})
	// prometheus metrics debug
	unknownInt0 = promauto.NewGauge(prometheus.GaugeOpts{
		Name: "unknown_int_0",
	})
	unknownInt1 = promauto.NewGauge(prometheus.GaugeOpts{
		Name: "unknown_int_1",
	})
	unknownInt2 = promauto.NewGauge(prometheus.GaugeOpts{
		Name: "unknown_int_2",
	})
	unknownInt3 = promauto.NewGauge(prometheus.GaugeOpts{
		Name: "unknown_int_3",
	})
	unknownInt4 = promauto.NewGauge(prometheus.GaugeOpts{
		Name: "unknown_int_4",
	})
	unknownInt5 = promauto.NewGauge(prometheus.GaugeOpts{
		Name: "unknown_int_5",
	})
	unknownInt6 = promauto.NewGauge(prometheus.GaugeOpts{
		Name: "unknown_int_6",
	})
	unknownInt7 = promauto.NewGauge(prometheus.GaugeOpts{
		Name: "unknown_int_7",
	})
	unknownInt8 = promauto.NewGauge(prometheus.GaugeOpts{
		Name: "unknown_int_8",
	})
	unknownInt9 = promauto.NewGauge(prometheus.GaugeOpts{
		Name: "unknown_int_9",
	})
	unknownInt10 = promauto.NewGauge(prometheus.GaugeOpts{
		Name: "unknown_int_10",
	})
	unknownInt11 = promauto.NewGauge(prometheus.GaugeOpts{
		Name: "unknown_int_11",
	})
	unknownInt12 = promauto.NewGauge(prometheus.GaugeOpts{
		Name: "unknown_int_12",
	})
)
...
func handleMetricsPacket(
	...
	// record metrics
	gridExportWatts.Set(float64(metrics.GridWatts))
	pvGenerationWatts.Set(float64(metrics.PVWatts))
	unknownInt0.Set(float64(metrics.UnknownInt0))
	unknownInt1.Set(float64(metrics.UnknownInt1))
	unknownInt2.Set(float64(metrics.UnknownInt2))
	unknownInt3.Set(float64(metrics.UnknownInt3))
	unknownInt4.Set(float64(metrics.UnknownInt4))
	unknownInt5.Set(float64(metrics.UnknownInt5))
	unknownInt6.Set(float64(metrics.UnknownInt6))
	unknownInt7.Set(float64(metrics.UnknownInt7))
	unknownInt8.Set(float64(metrics.UnknownInt8))
	unknownInt9.Set(float64(metrics.UnknownInt9))
	unknownInt10.Set(float64(metrics.UnknownInt10))
	unknownInt11.Set(float64(metrics.UnknownInt11))
	unknownInt12.Set(float64(metrics.UnknownInt12))
